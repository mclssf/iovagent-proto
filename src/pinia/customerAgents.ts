...
export function createActivatedCustomers(): ActivatedCustomer[] {
  ...
  const rows: Array<[string, string, string, string, '试用' | '正式', CustomerAgentBinding[]]> = [
    ['ent-jinyu', '金隅水泥', '2026-01-01', '2026-12-31', '正式', [employee('jinyu-cement-tms'), general(), project()]],
    ['ent-tsingtao', '青岛啤酒', '2026-04-01', '2027-03-31', '正式', [employee(), general(), project()]],
    ['ent-jinmailang', '今麦郎', '2026-06-01', '2027-05-31', '正式', [employee('jinmailang-logistics'), project()]],
    ['ent-anjie', '安捷物流', '2026-09-01', '2026-09-30', '试用', [general(), project()]],
    ['ent-zhilian', '智链顺达', '2026-03-01', '2027-02-28', '正式', [employee('zhilian-shunda-tms'), general(), project()]],
    ['ent-east', '华东物流事业部', '2026-07-01', '2027-06-30', '正式', [employee(), project()]],
    ['ent-southwest', '西南供应链中心', '2026-09-05', '2026-10-04', '试用', [general()]],
    ['ent-demo', '演示企业', '2026-09-01', '2026-09-30', '试用', []],
  ];
  return rows.map(([id, name, contractStart, contractEnd, activationType, agentConfigs]) => ({
    id, name, contractStart, contractEnd, activationType, agentConfigs, updatedAt: '2026-09-11 09:00', updatedBy: '系统管理员',
  }));
}
